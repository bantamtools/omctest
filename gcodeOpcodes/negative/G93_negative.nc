...
g93
g01 x100 y100 z5  (should return error code - tinyg currently does not)
g02 x10 y10 r10   (should return error code - tinyg currently does not)
g03 x20 y20 r10   (should return error code - tinyg currently does not)
